...
import org.jetbrains.kotlin.analysis.low.level.api.fir.api.createPackagePartProvider
import org.jetbrains.kotlin.analysis.low.level.api.fir.api.createSealedInheritorsProvider
...
internal object FirIdeSessionFactory {
    fun createSourcesSession(
        ...
        val session = FirIdeSourcesSession(module, project, contentScope, firBuilder, builtinTypes)
